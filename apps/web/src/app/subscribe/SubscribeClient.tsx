      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        <div className="flex flex-col gap-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-500/20 bg-amber-500/5 text-amber-400 text-xs font-semibold uppercase tracking-wider w-fit">
            <Zap className="w-3.5 h-3.5" /> Premium Access
          </div>
          <h1 className="text-4xl md:text-5xl font-bold leading-tight text-white">
            Intelligence,<br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-500 to-orange-400">Delivered First.</span>
          </h1>
          <p className="text-gray-400 text-lg leading-relaxed">
            Get uncompromising geopolitical analysis{" "}
          ...
          <div className="space-y-4">
            {["24-hour early access to all new reports.", "Exclusive Premium badge on your profile.", "Ad-free, tracker-free reading experience.", "Priority comment & bookmarking tools."].map((f, i) => (
        ...
        <div className="relative">
          ...
          <div className="relative border border-white/10 bg-[#080808] p-8 md:p-10 rounded-[2rem] shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs text-gray-300">Auto-expires</div>
            </div>
            <div className="mb-8">
            ...
            <button onClick={handlePayment} disabled={loading}
              ...
              {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Processing...</> : <>Unlock Premium Access <ArrowRight className="w-5 h-5" /></>}
            </button>
