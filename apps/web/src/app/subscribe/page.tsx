      ...
      <div className="w-full max-w-5xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="space-y-4">
            {[
              "24-hour early access to all new reports.",
        ...
        <div className="relative">
          ...
          <div className="relative border border-white/10 bg-[#080808] p-8 md:p-10 rounded-[2rem] shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="px-3 py-1 bg-white/5 border border-white/10 rounded-full text-xs font-medium text-gray-300">Auto-expires</div>
            </div>
            <div className="mb-8">
