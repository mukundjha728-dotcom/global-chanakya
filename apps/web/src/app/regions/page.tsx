...
import { REGIONS_DATA, STRATEGIC_SHIFTS } from "@/constants/regions";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 flex flex-col gap-8">
              {REGIONS_DATA.map((region) => (
                <div key={region.id} className="flex flex-col sm:flex-row gap-6 p-6 rounded-2xl glass-card border border-[var(--border)] hover:border-[var(--cyan)]/30 hover:-translate-y-1 transition-all duration-300 group">
                  <div className="w-full sm:w-[240px] aspect-[4/3] rounded-xl bg-[var(--surface)] overflow-hidden relative shrink-0 border border-[var(--border)] group-hover:border-[var(--cyan)]/20">
                    ...
                    <img src={region.image} alt={region.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                  ...
                  <div className="flex flex-col flex-1 py-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <span className="text-[10px] font-bold uppercase tracking-[0.14em] text-[var(--muted)] flex items-center gap-1">
                        <Clock className="w-3 h-3" /> Updated {region.lastUpdate}
                      </span>
                    </div>
