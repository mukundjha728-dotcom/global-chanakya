...
export function CountryTimeline({ events }: CountryTimelineProps) {
      ...
      <div className="relative border-l-2 border-gray-800 ml-3 space-y-8">
        {events.map((event) => (
          <div key={event._id} className="relative pl-6">
            <div className="absolute -left-[9px] top-1.5 w-4 h-4 rounded-full bg-purple-500 border-4 border-gray-950"></div>
            <time className="text-xs font-bold text-purple-400 uppercase tracking-wider mb-1 block">
