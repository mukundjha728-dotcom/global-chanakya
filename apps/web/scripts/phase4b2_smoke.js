...
async function runTest() {
  const urls = [
    ...
    '/blogs/world-order-shifting-india-strategic-autonomy-us-china-rivalry',
    '/blogs/india-defense-exports-agni-brahmos-tejas-indigenous-production',
    '/blogs/indian-ocean-region-navel-dominance-quad-china-string-of-pearls',
    '/blogs/india-middle-east-europe-economic-corridor-imeec-geopolitics',
    '/blogs/artificial-intelligence-military-cyber-warfare-future-conflicts',
    '/blogs/india-space-diplomacy-isro-gaganyaan-geopolitics-of-space',
    '/blogs/kashmir-article-370-abrogation-pakistan-terrorism-loc-analysis',
    '/blogs/brics-expansion-global-south-de-dollarization-multipolar-world',
    '/blogs/climate-change-geopolitics-energy-transition-green-hydrogen'
  ];
